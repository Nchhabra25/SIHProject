...
export default function InnovateIdeateChallenges() {
  return (
        ...
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl md:text-3xl font-bold">Ideate Challenges</h1>
            </div>
          </div>
        </div>
      </div>
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        <p className="text-muted-foreground mb-6">Solve open-ended eco-problems creatively and collaboratively.
        </p>
        <div className="grid grid-cols-2 gap-4 md:gap-6 mb-8">
          {[{k:"Challenges",v:"16"},{k:"Teams",v:"260"}].map(m=> (
