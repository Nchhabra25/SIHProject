...
export default function ActRun() {
  return (
        ...
        <div className="container mx-auto px-4 py-8 max-w-6xl">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl md:text-3xl font-bold">Go on a Run</h1>
            </div>
          </div>
        </div>
      </div>
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        <p className="text-muted-foreground mb-6">Plog runs: jog while picking up litter. Share before/after photos.</p>
        <div className="grid grid-cols-2 gap-4 md:gap-6 mb-8">
          {[{k:"Distance",v:"180 km"},{k:"Bags collected",v:"420"}].map(m=> (
