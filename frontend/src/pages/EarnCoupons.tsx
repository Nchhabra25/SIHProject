...
export default function EarnCoupons() {
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        <p className="text-muted-foreground mb-6">Get exclusive coupons from eco-friendly brands.
        </p>
        <div className="grid grid-cols-2 gap-4 md:gap-6 mb-8">
          {[{k:"Active",v:"9"},{k:"Redeemed",v:"21"}].map(m=> (
